  ...
  //  func application(app: UIApplication, openURL url: URL, options: [String : AnyObject]) -> Bool {
    ...
    public func sign(_ signIn: GIDSignIn!, didSignInFor user: GIDGoogleUser!, withError error: Error!) {
        if (error == nil) {
            ...
            googleUserDetails = GoogleUser(userID: userID!,
                                           idToken: idToken!,
                                           fullName: fullName!,
                                           givenName: givenName!,
            ...
            notificationCenter.post(
                name: ToggleAuthUINotification, object: nil, userInfo: nil)
            // [END_EXCLUDE]
        }
    }
...
//    // MARK: - Core Data stack  - moved to its own class
//
...
//    }
//    
    // End of CoreData.  Start of Garrys stuff
