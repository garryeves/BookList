...
//        )
    ...
    func getShelves()
    {
//        let requestURL = "https://www.goodreads.com/shelf/list.xml?id=\(goodReadsUserID)&key=\(APIKey)"
//print("Request = \(requestURL)")
//        _ = oAuth.client.get(
//            requestURL,
//            success:
...
//        }
//        
//  //      let requestURL = "https://www.goodreads.com/review/list?id=\(goodReadsUserID)&key=\(APIKey)&v=2&per_page=200&page=\(page)"
//        
//        let requestURL = "https://www.goodreads.com/review/list/\(goodReadsUserID).xml?key=\(APIKey)&v=2&per_page=200&page=\(page)"
//        
//        
//     //   let requestURL = "https://www.goodreads.com/review/list/7193459.xml?key=nQD4O5Bat2S5ZC9gc8zudA&v=2&per_page=200&page=1&shelf=to-re-read"
////print("Request = \(requestURL)")
//        _ = oAuth.client.get(
//            requestURL,
//            success:
...
//                {
//                    let myBook = Book()
//print("Name = \(review["book"]["title"].element!.text!)    ID = \(review["book"]["id"].element!.text!)")
...
//                    }
//                    
//                    myBook.removeShelves()
//                    
//                    for shelfDetails in review["shelves"].all
//                    {
//print("Assigned shelf = \(shelfDetails["shelf"].element?.attribute(by: "name")?.text)!)")
...
//                else
//                {
//                    // Now load back from database, as we have added any updates to the booklist to the database
//                    
//                    self.loadBooks()
//                    
